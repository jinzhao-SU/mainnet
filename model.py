...
class MainNet(nn.Module):
    def __init__(self):
        ...
        #self.max_pool_3d2 = nn.MaxPool3d(kernel_size=3, stride=1)
        ...
        self.sub_conv3 = nn.Conv3d(in_channels=self.out2, out_channels=self.out3, kernel_size=(2,2,5), stride=(1, 1, 1))
        ...
        #self.fc1 = nn.Linear(64*22*22, 100*100)
        # self.fc2 = nn.Linear(64*22*22, 64*22*11)
        #self.fc3 = nn.Linear(32*22*22, 100*100)
